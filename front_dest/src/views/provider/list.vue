<template>
  <div>
    <div class="search_form">
      <a-input placeholder="请输入供应商名称" v-model="searchForm.name"  style="width:200px;margin-right:30px;"></a-input>
      <a-input placeholder="请输入供应商地址" v-model="searchForm.address" style="width:200px;margin-right:30px;"></a-input>
      <a-input placeholder="请输入供应商联系方式" v-model="searchForm.phone" style="width:200px;margin-right:30px;"></a-input>
    ...
    >
      <a-form  :model="form">
        ...
        <a-form-item label="供应商地址" required>
          <a-input v-model="form.address" allowClear/>
        </a-form-item>
        <a-form-item label="供应商联系方式" required>
...
export default{
  ...
  methods:{
    ...
    async submit(){
      if (!this.form.name) return this.$message.warning("请输入供应商名称")
      if (!this.form.address) return this.$message.warning("请输入供应商地址")
      if (!this.form.phone) return this.$message.warning("请输入供应商联系方式")
      const params = new URLSearchParams()
